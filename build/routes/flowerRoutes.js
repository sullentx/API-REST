...
flowerRoutes.post('/flower', auth_1.authMiddleware, roleMiddleware_1.adminMiddleware, flowerController_1.createFlower);
flowerRoutes.put('/flower/:id', auth_1.authMiddleware, roleMiddleware_1.adminMiddleware, flowerController_1.updateFlower);
